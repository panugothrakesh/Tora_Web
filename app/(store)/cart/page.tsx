        ...
        <div className="container mx-auto p-4 max-w-6xl">
            ...
            >
                <div className="flex justify-end space-x-2">
                    ...
                    <Button variant="destructive" className='bg-red-500 hover:bg text-white' onClick={confirmRemoveAddress}>
                        Confirm
                    </Button>
                </div>
            </Modal>
                        ...
                        <div className="mt-4">
                            {addresses.length > 0 ? (
                                addresses.map((address, index) => (
                                    <label
                                        key={index}
                                        className={`flex flex-col md:flex-row gap-4 md:gap-0 mb-2 items-end md:items-center justify-between p-2 px-4 border rounded cursor-pointer ${selectedAddressIndex === index ? 'border-black bg-gray-100' : ''
                                            }`}
                                    >
