...
// Query: *[_type == "category"] | order(_updatedAt asc)
...
// Query: *[_type == "product"] | order(_updatedAt asc)
...
// Source: ./sanity/lib/products/getProductByCategory.tsx
// Variable: PRODUCTS_BY_CATEGORY_QUERY
// Query: *[_type == "product" && references(        *[_type == "category" && slug.current == $categorySlug]._id    )] | order(_updatedAt asc)
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"category\"] | order(_updatedAt asc)": ALL_CATEGORIES_QUERYResult;
    "*[_type == \"product\"] | order(_updatedAt asc)": ALL_PRODUCTS_QUERYResult;
    "*[_type == \"product\" && references(\n        *[_type == \"category\" && slug.current == $categorySlug]._id\n    )] | order(_updatedAt asc)": PRODUCTS_BY_CATEGORY_QUERYResult;
